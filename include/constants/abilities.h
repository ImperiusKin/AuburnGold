...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_BLAZING_SOUL = 319,
    ABILITY_STRIKER = 320,
    ABILITY_PARASITIC_WASTE = 321,
    ABILITY_BULL_RUSH = 322,
    ABILITY_SELF_SUFFICIENT = 323,
    ABILITY_ICE_EATER = 324,
    ABILITY_FATAL_PRECISION = 325,
    ABILITY_MOUNTAINEER = 326,
    ABILITY_PROWESS = 327,
    ABILITY_FLURRY = 328,
    ABILITY_BONE_ZONE = 329,
    ABILITY_SAGE_POWER = 330,
    ABILITY_EMPEROR_PRESENCE = 331,
    ABILITY_WAYWARD = 332,
    ABILITY_BAD_COMPANY = 333,
    ABILITY_THE_GRIPPER = 334,
    ABILITY_ICE_BODY_OLD = 335,
