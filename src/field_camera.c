...
static void DrawMetatile(s32 metatileLayerType, const u16 *tiles, u16 offset)
{
    ...
    {
        // Door metatile: only 8 tile-slots are valid (see DrawDoorMetatileAt),
        // drawn using the old covered-layer-type placement (bottom+middle).
    ...
    {
        // Triple-layer metatile: all three BG layers are drawn independently
        // from the metatile's own bottom/middle/top tile-slots.
        gOverworldTilemapBuffer_Bg3[offset] = tiles[0];
        gOverworldTilemapBuffer_Bg3[offset + 1] = tiles[1];
        gOverworldTilemapBuffer_Bg3[offset + 0x20] = tiles[2];
        gOverworldTilemapBuffer_Bg3[offset + 0x21] = tiles[3];
