...
#if P_FAMILY_VAROOM
static const struct FormChange sRevavroomFormChangeTable[] =
{
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_REVAVROOM,         ITEM_ENGINE_BAY, 0},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_REVAVROOM_SEGIN,   ITEM_ENGINE_BAY, 1},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_REVAVROOM_SCHEDAR, ITEM_ENGINE_BAY, 2},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_REVAVROOM_NAVI,    ITEM_ENGINE_BAY, 3},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_REVAVROOM_RUCHBAH, ITEM_ENGINE_BAY, 4},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_REVAVROOM_CAPH,    ITEM_ENGINE_BAY, 5},
    {FORM_CHANGE_TERMINATOR},
};
...
{
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_CASTFORM_NORMAL, ITEM_WEATHER_REPORT, 0},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_CASTFORM_RAINY,  ITEM_WEATHER_REPORT, 1},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_CASTFORM_SUNNY,  ITEM_WEATHER_REPORT, 2},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_CASTFORM_SNOWY,  ITEM_WEATHER_REPORT, 3},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_CASTFORM_SANDY,  ITEM_WEATHER_REPORT, 4},
...
{
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_TAUROS,                ITEM_BULL_ESSENCE, 0},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_TAUROS_PALDEA_COMBAT,  ITEM_BULL_ESSENCE, 1},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_TAUROS_PALDEA_AQUA,    ITEM_BULL_ESSENCE, 2},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_TAUROS_PALDEA_BLAZE,   ITEM_BULL_ESSENCE, 3},
    {FORM_CHANGE_TERMINATOR},
};
#endif //P_FAMILY_ROTOM
