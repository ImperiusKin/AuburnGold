...
static const struct FormChange sRevavroomFormChangeTable[] =
{
    ...
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_REVAVROOM, ITEM_ENGINE_BAY, 1},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_REVAVROOM, ITEM_ENGINE_BAY, 2},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_REVAVROOM, ITEM_ENGINE_BAY, 3},
};
#endif //P_FAMILY_SNORUNT
