...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_DARTRIX] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_DECIDUEYE, CONDITIONS({IF_TIME, TIME_NIGHT})}
                            #if P_HISUIAN_FORMS
                                ,{EVO_LEVEL, 36, SPECIES_DECIDUEYE_HISUI, CONDITIONS({IF_NOT_TIME, TIME_NIGHT})}
                            #endif
                            ),
    },
    ...
    [SPECIES_LITTEN] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_DEFIANT, ABILITY_INTIMIDATE },
    ...
    [SPECIES_POPPLIO] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_PRANKSTER, ABILITY_LIQUID_VOICE },
    ...
    [SPECIES_YUNGOOS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 16, SPECIES_GUMSHOOS, CONDITIONS({IF_NOT_TIME, TIME_NIGHT})}),
    },
    ...
    [SPECIES_GRUBBIN] =
    {
        ...
        .abilities = { ABILITY_SWARM, ABILITY_HYPER_CUTTER, ABILITY_STATIC },
    ...
    [SPECIES_CHARJABUG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_BATTERY, ABILITY_STATIC, ABILITY_VOLT_ABSORB },
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 62, SPECIES_VIKAVOLT},
    ...
    [SPECIES_VIKAVOLT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_LEVITATE, ABILITY_MAGNET_PULL, ABILITY_SURGE_SURFER },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CRABOMINABLE_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_IRON_FIST, ABILITY_IRON_FIST, ABILITY_SLUSH_RUSH },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Crabominable"),
    ...
    [SPECIES_ORICORIO_BAILE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_DANCER, ABILITY_FLASH_FIRE, ABILITY_FLAME_BODY },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_ORICORIO_POM_POM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_DANCER, ABILITY_STATIC, ABILITY_VOLT_ABSORB },
    ...
    [SPECIES_ORICORIO_PAU] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_DANCER, ABILITY_ANALYTIC, ABILITY_TRACE },
    ...
    [SPECIES_ORICORIO_SENSU] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_DANCER, ABILITY_CURSED_BODY, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Oricorio"),
    ...
    [SPECIES_LYCANROC_DUSK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_SCRAPPY, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Lycanroc"),
    ...
    [SPECIES_DEWPIDER] =
    {
        ...
        .abilities = { ABILITY_WATER_BUBBLE, ABILITY_HYDRATION, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_FOMANTIS] =
    {
        ...
        .abilities = { ABILITY_LEAF_GUARD, ABILITY_HARVEST, ABILITY_CONTRARY },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_SALANDIT] =
    {
        ...
        .abilities = { ABILITY_CORROSION, ABILITY_FLAME_BODY, ABILITY_OBLIVIOUS },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_PASSIMIAN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_RECEIVER, ABILITY_STAKEOUT, ABILITY_DEFIANT },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_SANDYGAST] =
    {
        ...
        .abilities = { ABILITY_WATER_COMPACTION, ABILITY_SAND_SPIT, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_BROWN,
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal, heldItem)\
    ...
    [SPECIES_KOMALA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_COMATOSE, ABILITY_OWN_TEMPO, ABILITY_INNER_FOCUS },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DRAMPA_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_BERSERK, ABILITY_BERSERK, ABILITY_DRIZZLE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Drampa"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_DHELMISE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_STEELWORKER, ABILITY_WATER_ABSORB, ABILITY_PERISH_BODY },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_TAPU_KOKO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_ELECTRIC_SURGE, ABILITY_ELECTRIC_SURGE, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_TAPU_LELE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PSYCHIC_SURGE, ABILITY_PSYCHIC_SURGE, ABILITY_MAGIC_GUARD },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_TAPU_BULU] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_GRASSY_SURGE, ABILITY_GRASSY_SURGE, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_TAPU_FINI] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_MISTY_SURGE, ABILITY_MISTY_SURGE, ABILITY_STORM_DRAIN },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_COSMOG] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_UNAWARE, ABILITY_NATURAL_CURE, ABILITY_LEVITATE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_COSMOEM] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_STURDY, ABILITY_SHELL_ARMOR, ABILITY_FILTER },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 64, SPECIES_SOLGALEO, CONDITIONS({IF_NOT_TIME, TIME_NIGHT})},
                                {EVO_LEVEL, 64, SPECIES_LUNALA, CONDITIONS({IF_TIME, TIME_NIGHT})}),
    },
    ...
    [SPECIES_SOLGALEO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_FULL_METAL_BODY, ABILITY_FULL_METAL_BODY, ABILITY_FLASH_FIRE },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_LUNALA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SHADOW_SHIELD, ABILITY_SHADOW_SHIELD, ABILITY_LEVITATE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_NIHILEGO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_BEAST_BOOST, ABILITY_BEAST_BOOST, ABILITY_LEVITATE },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_BUZZWOLE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_BEAST_BOOST, ABILITY_BEAST_BOOST, ABILITY_IRON_FIST },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_PHEROMOSA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_BEAST_BOOST, ABILITY_BEAST_BOOST, ABILITY_STRIKER },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_XURKITREE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_BEAST_BOOST, ABILITY_BEAST_BOOST, ABILITY_MOTOR_DRIVE },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_CELESTEELA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_BEAST_BOOST, ABILITY_BEAST_BOOST, ABILITY_FILTER },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_KARTANA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_BEAST_BOOST, ABILITY_BEAST_BOOST, ABILITY_SHARPNESS },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_GUZZLORD] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_BEAST_BOOST, ABILITY_BEAST_BOOST, ABILITY_GLUTTONY },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_NECROZMA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRISM_ARMOR, ABILITY_PRISM_ARMOR, ABILITY_MIRROR_ARMOR },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_NECROZMA_DUSK_MANE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRISM_ARMOR, ABILITY_PRISM_ARMOR, ABILITY_FLASH_FIRE },
        .bodyColor = BODY_COLOR_YELLOW,
        .noFlip = TRUE,
        .speciesName = _("Necrozma"),
    ...
    [SPECIES_NECROZMA_DAWN_WINGS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRISM_ARMOR, ABILITY_PRISM_ARMOR, ABILITY_LEVITATE },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
        .speciesName = _("Necrozma"),
    ...
    [SPECIES_NECROZMA_ULTRA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_NEUROFORCE, ABILITY_NEUROFORCE, ABILITY_ILLUMINATE },
        .bodyColor = BODY_COLOR_YELLOW,
        .noFlip = TRUE,
        .speciesName = _("Necrozma"),
    ...
    [SPECIES_MAGEARNA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SOUL_HEART, ABILITY_SOUL_HEART, ABILITY_STALWART },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_MAGEARNA_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SOUL_HEART, ABILITY_SOUL_HEART, ABILITY_FILTER },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Magearna"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_POIPOLE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_BEAST_BOOST, ABILITY_BEAST_BOOST, ABILITY_CORROSION },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_STAKATAKA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_BEAST_BOOST, ABILITY_BEAST_BOOST, ABILITY_BULLETPROOF },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
    ...
    [SPECIES_BLACEPHALON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_BEAST_BOOST, ABILITY_BEAST_BOOST, ABILITY_INARDS_OUT },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_MELTAN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_MAGNET_PULL, ABILITY_MAGNET_PULL, ABILITY_CLEAR_BODY },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_MELMETAL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_IRON_FIST, ABILITY_IRON_FIST, ABILITY_BULLETPROOF },
        .bodyColor = BODY_COLOR_GRAY,
